          ...
          Column(
            children: [
                    ...
                    child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            BlocBuilder<ControllerFenceBloc,
                                ControllerStateFence>(
                              builder: (context, state) {
                    ...
                    child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            BlocBuilder<ControllerBlocDoor,
                                ControllerStateDoor>(
                              builder: (context, state) {
                                dateFormat = DateFormat("yyyy-MM-dd H:mm:ss")
                                    .format(DateTime.now());
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: BlocBuilder<ControllerFanBloc, ControllerFanState>(
                        builder: (context, state) {
                      dateFormat = DateFormat("yyyy-MM-dd H:mm:ss")
                          .format(DateTime.now());
                  ...
                  Expanded(
                    child: BlocBuilder<ControllerIronBloc, ControllerIronState>(
                      builder: (context, state) {
                        dateFormat = DateFormat("yyyy-MM-dd H:mm:ss")
                            .format(DateTime.now());
                        return GestureDetector(
                  ...
                  Expanded(
                    child: BlocBuilder<ControllerLampPatioBloc,
                        ControllerLampPatioState>(
                      builder: (context, state) {
                        dateFormat = DateFormat("yyyy-MM-dd H:mm:ss")
                            .format(DateTime.now());
                        return GestureDetector(
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: BlocBuilder<ControllerLampLivingRoomBloc,
